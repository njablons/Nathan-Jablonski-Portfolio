...
![Simple Wall Thickness CAD Model](Screenshot 2026-09-09 164044.png)
...
![PrusaSlicer Oversized Unit Import Issue](Screenshot 2026-09-09 164059.png)
*Figure 2: Model initially loaded into PrusaSlicer oversized due to an inch-to-millimeter unit mismatch.*

![PrusaSlicer Settings and Rescaled Model](Screenshot 2026-09-09 164435.png)
*Figure 3: Rescaled model (3.94% scale factor adjustment) displaying 15% infill setting and correct $30\text{ mm} \times 15\text{ mm} \times 13\text{ mm}$ bounding box.*
...
- **Results:** The 1.2 mm and 0.8 mm walls printed cleanly with rigid structure. The 0.4 mm single-perimeter wall printed successfully but displayed noticeable flexibility and low structural rigidity.
...
<video src="IMG_4063.mov" controls title="Active Print Process"></video>
*Video 1: 15-second recording of the Prusa CORE One actively printing the benchmark model.*
